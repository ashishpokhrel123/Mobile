      ...
      @section('change')
		...
		<link href="{{ url('bootstrap/css/style1.css')}}" rel="stylesheet" />
...
<div align="left" style="min-height:800px;">
	...
	<div id="wrap" align="center">
		...
		<a id="show_cart" href="{{ url('bootstrap/javascript:void(0)')}}">View My Cart</a>
		
		<ul>
			<li id="1">
				<img src="{{ url('bootstrap/images/m1.jpg')}}" class="items" alt="" />
			...
			<li id="2">
				<img src="{{ url('bootstrap/images/m2.jpg')}}" class="items" alt="" />
			...
			<li id="3">
				<img src="{{ url('bootstrap/images/m4.jpg')}}" class="items" alt="" />
				
				<br clear="all" />
				<div>Product-Name</div>
			</li>
			<li id="4">
				<img src="{{ url('bootstrap/images/m6.jpg')}}" class="items" alt="" />
			...
			<div class="detail-view" id="detail-1">
				...
				<div class="close" align="right">
					<a href="{{ url('bootstrap/javascript:void(0)')}}">x</a>
					
				</div>
				
				<img src="{{ url('bootstrap/images/m1.jpg')}}" class="detail_images" alt="" />
			...
			<div class="detail-view" id="detail-2">
				...
				<img src="{{ url('bootstrap/images/m2.jpg')}}" class="detail_images" alt="" />
			...
			<div class="detail-view" id="detail-3">
				...
				<img src="{{ url('bootstrap/images/m4.jpg')}}" class="detail_images" alt="" />
			...
			<div class="detail-view" id="detail-4">
				...
				<img src="{{ url('bootstrap/images/m6.jpg')}}" class="detail_images" alt="" />
			...
			<li id="7">
				<img src="{{ url('bootstrap/images/m7.jpg')}} class="items" alt="" />
			...
			<div class="detail-view" id="detail-13">
				...
				<img src="{{ url('bootstrap/images/13.jpg')}}" class="detail_images" alt="" />
